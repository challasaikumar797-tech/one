  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    :root {
      ...
      --accent: #c76b5a;
      --accent-light: #efd2c9;
      --accent-glow: rgba(199, 107, 90, 0.15);
      --muted: #6e6e7e;
      --muted-light: #b0b0bf;
    ...
    .btn-secondary:hover {
      ...
      box-shadow: 0 12px 24px rgba(30,30,44,0.12);
    }
    .btn-outline {
      background: transparent; border-color: rgba(30,30,44,0.12); color: var(--primary);
    }
    .btn-outline:hover {
      background: var(--primary); color: #fff; border-color: var(--primary);
    }
    ...
    .icon-btn:hover { background: var(--accent-light); color: var(--primary); }
    ...
    .search-wrap {
      display: flex; align-items: center; background: #f0efec;
    ...
    .mobile-toggle {
      ...
      background: var(--bg); font-size: 20px; color: var(--primary);
      transition: var(--transition);
    }
    .mobile-toggle:hover { background: var(--accent-light); }
    #mobileMenu {
      display: none; background: #fff; border-top: 1px solid rgba(0,0,0,0.02);
      padding: 12px 0 20px;
    }
    #mobileMenu ul {
    ...
    #mobileMenu ul li a:hover { background: var(--bg); }
    ...
    .hero {
      ...
      background: linear-gradient(145deg, #1e1e2c 0%, #2e2e48 100%);
    }
    .hero::before {
    ...
    .hero p {
      color: rgba(255,255,255,0.75); font-size: 17px; max-width: 480px;
    ...
    .cat-card:hover {
      ...
      background: #fff; border-color: var(--accent-light);
    }
    .cat-card .icon-wrap {
    ...
    .product-card .img-wrap {
      position: relative; overflow: hidden; background: #f2f1ee;
      aspect-ratio: 1/1;
    }
    ...
    .product-card .badge.sale { background: #d4b872; color: var(--primary); }
    ...
    .product-card .footer .add-btn.added { background: #2f8f7a; }
    ...
    .deal-wrap .deal-img {
      flex: 0 0 46%; background: #eae8e4; min-height: 280px;
    }
    ...
    .deal-wrap .deal-content .tag {
      display: inline-block; background: #f7e6b3; color: var(--primary);
    ...
    /* ----- newsletter (refined) ----- */
    .newsletter-wrap {
      background: linear-gradient(135deg, #1e1e2c 0%, #2e2e48 100%);
    ...
    .newsletter-wrap form input {
      ...
      color: #fff; transition: var(--transition); outline: 1px solid transparent;
    }
    .newsletter-wrap form input::placeholder { color: rgba(255,255,255,0.4); }
    .newsletter-wrap form input:focus {
      outline-color: var(--accent); background: rgba(255,255,255,0.14);
    }
    ...
    /* ----- footer (light) ----- */
    footer { margin-top: 16px; padding: 48px 0 28px; border-top: 1px solid rgba(0,0,0,0.03); }
    .footer-grid {
    ...
    .footer-grid .col h5 { font-weight: 700; font-size: 14px; margin-bottom: 14px; }
    ...
    .footer-bottom {
      text-align: center; padding-top: 20px; border-top: 1px solid rgba(0,0,0,0.03);
...
<body>
  ...
  <main>
    ...
    <section class="section" id="deals" aria-labelledby="deals-title">
      <div class="container">
        <div class="section-header">
          <div class="title-group"><h2 id="deals-title">⚡ Flash Deal</h2><p>Limited stock — don't miss out</p></div>
        </div>
        <div class="deal-wrap">
    ...
    <section class="section" id="testimonials" aria-labelledby="test-title">
      <div class="container">
        <div class="section-header">
          <div class="title-group"><h2 id="test-title">What Our Customers Say</h2><p>Real reviews from real people</p></div>
        </div>
  ...
  <script>
    ...
    function renderProducts(list) {
      ...
      list.forEach(p => {
        ...
        el.innerHTML = `
          <div class="img-wrap"><img src="${p.img}" alt="${p.title}" loading="lazy">${badgeHtml}<button class="wish-btn" aria-label="Add to wishlist"><i class="far fa-heart"></i></button></div>
      ...
      productsGrid.querySelectorAll('.add-btn').forEach(btn => {
        btn.addEventListener('click', function(e) { e.stopPropagation(); const id = Number(this.dataset.id); addToCart(id, this); });
      });
    }
    ...
    (function setupDealTimer() {
      ...
      function tick() {
        ...
        if (diff <= 0) { $('dealDays').textContent = '0'; $('dealHours').textContent = '00'; $('dealMinutes').textContent = '00'; $('dealSeconds').textContent = '00'; return; }
    ...
    mobileMenu.querySelectorAll('a').forEach(link => {
      link.addEventListener('click', () => { mobileMenu.style.display = 'none'; mobileToggle.innerHTML = '<i class="fas fa-bars"></i>'; });
    });
    ...
    $('cartBtn').addEventListener('click', () => alert(`🛒 Your cart has ${cartCount} item${cartCount !== 1 ? 's' : ''}.`));
    ...
    console.log('✨ NexusShop — modern UI loaded.');
  </script>
</body>
</html>
